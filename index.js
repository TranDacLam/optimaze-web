...
// - run script
// - Add event "mouseover", "keydown", "touchmove", "touchstart", "wheel"
// - Người dùng thao tác các event trên thì sẽ stop worker, mutationObserver, remove event trên
// - append lại các thẻ script đã dừng và xóa các thẻ script có type = "text/spdnscript"

const t = ["mouseover", "keydown", "touchmove", "touchstart", "wheel"];
...
function u() {
    if (perfEntries[0]["loadEventEnd"] > 0) {opti
        console.log('u=1');
